 ...
 * @author Thiag
 */
public class CadastrarCoordenadores extends javax.swing.JDialog {
    
    private static final java.util.logging.Logger logger = java.util.logging.Logger.getLogger(CadastrarCoordenadores.class.getName());
    Controle controle;
    ArrayList<String> listaTemp = new ArrayList();
    /**
     * Creates new form CadastrarCoordenadores
     */
    public CadastrarCoordenadores(JDialog parent, boolean modal, Controle controle) {
        super(parent, modal);

 ...
 * @author Thiag
 */
public class EditarAgendamentos extends javax.swing.JDialog {
    
    private static final java.util.logging.Logger logger = java.util.logging.Logger.getLogger(EditarAgendamentos.class.getName());
    Agendamento agendamento;
    /**
     * Creates new form Editaragendamentos
     */
    public EditarAgendamentos(JDialog parent, boolean modal, Agendamento agendamento) {
        super(parent, modal);
        ...
        tfdValor.setText(String.valueOf(agendamento.getValor()));
        taEntrada.setText(agendamento.getObjetivo());
                    ...
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
                            .addGroup(jPanel1Layout.createSequentialGroup()
                                ...
                                .addComponent(tfdHorario, javax.swing.GroupLayout.PREFERRED_SIZE, 127, javax.swing.GroupLayout.PREFERRED_SIZE))
                            .addGroup(jPanel1Layout.createSequentialGroup()
                                .addGap(44, 44, 44)

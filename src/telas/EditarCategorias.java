...
public class EditarCategorias extends javax.swing.JDialog {
     ...
     */
    public EditarCategorias(JDialog parent, boolean modal, Categoria categoria) {
        super(parent, modal);
        this.categoria = categoria;
        initComponents();
        
        tfdNome.setText(categoria.getNome());
        tfdCod.setText(String.valueOf(categoria.getCod()));
    ...
    private void initComponents() {
        ...
        jLabel2.setText("CODÍGO CATEGORIA:");
